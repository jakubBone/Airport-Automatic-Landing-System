...
public class Airport {
    ...
    public Airport() {
        this.runway1 = createRunwayWithCorridor("R-1", "C-1", new Location(500, -2000, 0), new Location(-5000, -2000, 1000), true);
        this.runway2 = createRunwayWithCorridor("R-2", "C-2", new Location(500, 1000, 0), new Location(-5000,  1000, 1000), true);
    }
